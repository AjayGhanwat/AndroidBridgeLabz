...
public class MainPanelActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        myDoc = FirebaseFirestore.getInstance().collection("Data").document(userID).collection("Notes");
    ...
    void refreshUserDataRecycler(){
        ...
        if (fragName.equals("Note")) {
            ...
            NoteFragment.updateNewData(myDoc);

        } else if (fragName.equals("Reminder")) {

            ReminderFragment.updateNewData(myDoc);

        } else if (fragName.equals("Archive")) {

            ArchiveFragment.updateNewData(myDoc);

        } else if (fragName.equals("Trash")) {

            TrashFragment.updateNewData(myDoc);
