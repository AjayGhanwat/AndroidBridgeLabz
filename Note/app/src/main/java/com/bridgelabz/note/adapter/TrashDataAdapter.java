...
public class TrashDataAdapter extends RecyclerView.Adapter<TrashDataAdapter.userViewHolder> {
    ...
    @Override
    public TrashDataAdapter.userViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
    ...
    @Override
    public void onBindViewHolder(TrashDataAdapter.userViewHolder holder, int position) {
